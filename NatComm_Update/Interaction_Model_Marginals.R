...
domain_X_outcome.margins <- emmeans(domain_X_outcome_model, ~ Domain.2*OutcomeVariable, level=hdi_width)
type_outcome.margins <- emmeans(type_outcome_model, ~ Ex.Mode.2 + OutcomeVariable, level=hdi_width)
domain_X_type.margins <- emmeans(domain_X_type_model, ~ Domain.2*Ex.Mode.2, level=hdi_width)

domain_X_outcome.margins.prior <- emmeans(unupdate(domain_X_outcome_model),
                                          ~ Domain.2*OutcomeVariable, level=hdi_width)
...
domain_X_type.margins.prior <- emmeans(unupdate(domain_X_type_model),
                                       ~ Domain.2*Ex.Mode.2, level=hdi_width)
...
saveRDS(model.marginals, 'interaction_model_marginals.rds')
...
saveRDS(model.marginals.priors, 'interaction_model_priors_marginals.rds')
...
saveRDS(model.bfs, 'interaction_model_parameter_bfs.rds')
